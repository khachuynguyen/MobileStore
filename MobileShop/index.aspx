<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MobileShop.index" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-6">
                        <div class="location_icon_bottum">
                            <ul>
                                <li><img src="icon/call.png" />0123456789</li>
                                <li><img src="icon/email.png" />team2@gmail.com</li>
                                <li><img src="icon/loc.png" />Dai Hoc Duy Tan</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="brand-bg">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <a href="brand.aspx" class="read-more">See More</a>
                    </div>
    ...
    <div class="clients">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="titlepage">
                        <h2>About Duy Tan University</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row pdn-top-30">
                    <div class="col-md-12 ">
                        <div class="footer-box">
                            <div class="headinga">
                                <h3>Address</h3>
                                <span>Dai hoc Duy Tan, Da Nang - Viet Nam</span>
                                <p>0123456789
                                    <br>team2@gmail.com</p>
                            </div>
